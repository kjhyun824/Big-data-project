...
public class PasswordCrackerMasterMain {
    public static void main(String[] args) {
        ...
        try {
            ...
            HashMap<String, Integer> workerInfoMap = (HashMap<String, Integer>) parser.parse(new FileReader("/home/CSE48101_61101/bd20175052/2_20175052/PasswordCrackerThrift/PasswordCrackerMaster/WorkerInfoList.json"));
